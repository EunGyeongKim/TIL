# 2022/09/04 프로그래머스_2021 kakao_신규아이디 추천
...
def solution(new_id):
    ...
    # 2
    for i in new_id:
        # isalnum = The isalnum() method returns True if all characters in the string are alphanumeric (either alphabets or numbers).
